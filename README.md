...
|--------|------|-----|------|-----|------------|
| brv32_mcu | 37 | 22 | 0 | 0 | 246.2 |

*Auto-generated by Vivado batch synthesis. Clock target: 100 MHz. Note: low utilization is expected — instruction and data memories contain no initialisation data at synthesis time, causing Vivado to optimise away most of the datapath.*
